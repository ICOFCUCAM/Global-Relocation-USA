        ...
        <div className="grid lg:grid-cols-5 gap-10 items-start">
          <div className="lg:col-span-2">
            ...
            <p className="text-slate-600 leading-relaxed mb-6">
              Global Relocation USA operates as a digital relocation coordination platform connecting
              customers with licensed moving providers. The platform supports regulator-aware workflows
              and transparent disclosure surfaces.
            </p>
            ...
            <div className="bg-amber-50 border-l-4 border-amber-400 rounded-r-lg p-4 flex gap-3">
              ...
              <div>
                ...
                <div className="text-sm text-amber-800 leading-relaxed">
                  Global Relocation USA is not a motor carrier. The platform connects customers with
                  independent licensed relocation service providers.
                </div>
              </div>
            </div>
