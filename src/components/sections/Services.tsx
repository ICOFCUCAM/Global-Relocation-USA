      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="max-w-3xl mb-14">
          ...
          <p className="text-lg text-slate-600 leading-relaxed">
            FlyttGo orchestrates the full relocation stack — from labor and carrier matching to storage,
            insurance, and enterprise programs — across United States markets.
          </p>
        </div>
