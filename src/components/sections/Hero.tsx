        ...
        <div className="grid lg:grid-cols-2 gap-12 items-center">
          <div>
            ...
            <p className="text-lg text-slate-300 leading-relaxed mb-8 max-w-xl">
              Global Relocation USA is a digital coordination marketplace connecting customers with licensed
              movers, relocation crews, storage providers, packing services, truck rental partners, and
              insurance selection layers — across the United States.
            </p>
          ...
          <div className="relative">
            <div className="bg-white/5 backdrop-blur border border-white/10 rounded-2xl p-6 lg:p-8 shadow-2xl">
              ...
              <div className="mt-5 bg-[#0066ff]/10 border border-[#0066ff]/20 rounded-lg p-3 text-xs text-blue-200 leading-relaxed">
                ...
                Global Relocation USA is not a motor carrier.
              </div>
            </div>
          </div>
        </div>
